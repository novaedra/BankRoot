...
public class BaseModelORM {
    ...
    public PreparedStatement getDeleteQuery(Connection dbConnection) {
        String deleteQueryString = this.getDeleteString();
        PreparedStatement statement = null;

        try {
            statement = dbConnection.prepareStatement(deleteQueryString, Statement.RETURN_GENERATED_KEYS);
